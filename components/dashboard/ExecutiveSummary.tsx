  ...
  return (
    <section className="rounded-2xl border border-[#dce7e1] bg-white p-6 shadow-[0_4px_16px_rgba(25,65,49,0.04)] sm:p-7">
      ...
      <ul className="mt-5 space-y-4">
        {summary.map((point) => <li key={point} className="flex gap-3 text-sm leading-6 text-[#50685e]"><span className="mt-2 size-1.5 shrink-0 rounded-full bg-[#68a78a]" />{point}</li>)}
      </ul>
    </section>
  );
}
